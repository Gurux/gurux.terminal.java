...
package gurux.terminal.example.java;
...
/**
 *
 * Gurux terminal example for Java.
 */
public class GuruxTerminalExampleJava extends javax.swing.JFrame
    ...
    public void actionPerformed(ActionEvent e) {
        this.ReceivedStat.setText(String.valueOf(terminal.getBytesReceived()));
        this.SentStat.setText(String.valueOf(terminal.getBytesSent()));
        terminal.resetByteCounters();
    }

    @Override
    public final void onMediaStateChange(Object sender, MediaStateEventArgs e) {
        try {
     ...
     * Creates new form.
     */
    public GuruxTerminalExampleJava() {
        initComponents();
        ...
        DefaultListModel<String> m =
                (DefaultListModel<String>) ReceivedTB.getModel();
        m.clear();
        onMediaStateChange(terminal,
                new MediaStateEventArgs(MediaState.CLOSED));
    }
    ...
    private void SendBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_SendBtnActionPerformed
        try {
            terminal.send(SendTB.getText(), null);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger
                    .getLogger(GuruxTerminalExampleJava.class.getName())
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuruxTerminalExampleJava().setVisible(true);
            }
        });
    }
